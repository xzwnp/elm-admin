<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <el-table-column prop="id" label="角色编号" header-align="center" align="center"></el-table-column>
        <el-table-column prop="role" label="角色名" header-align="center" align="center"></el-table-column>
...
import {getData, del} from '@/api/sys/role'
